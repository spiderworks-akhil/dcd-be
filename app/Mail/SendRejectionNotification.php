...
class SendRejectionNotification extends Mailable
{
    ...
    public function build()
{
    ...
    $subject = "{$this->approval->notifiable_type} Submission Rejected: {$this->record->name}";

    return $this->subject($subject)
        ->view('email.rejection_notification')
        ->with([
