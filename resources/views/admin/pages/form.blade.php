                                    ...
                                    @endif
                                            ...
                                            <!-- @fieldshow(pages-faq)
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="faqid" class="card-body text-center">
...
<script>
   document.getElementById('submitBtn').addEventListener('click', function() {
    ...
    var table = "pages";
    var route = "admin.pages";

    var url = "{{ route('admin.clone-slug') }}?type=" + selectedValue + "&slug=" + slug + "&name=" + name + "&table=" + table + "&route=" + route;
