        ...
        <div id="form-vertical" class="form-horizontal form-wizard-wrapper">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    @if ($obj->type == 'en')
                        <a href="{{route('admin.listing-items.index',[15])}}" class="btn btn-primary" target="_blank">About message learn more listing
                        </a>
                        <input type="hidden" name="content[message_learn_more_listing_id]" value="15">
                    @else
                        <a href="{{route('admin.listing-items.index',[27])}}" class="btn btn-primary" target="_blank">About message learn more listing
                        </a>
                        <input type="hidden" name="content[message_learn_more_listing_id]" value="27">
                    @endif
                    </div>
            </fieldset>
