                        ...
                        <div class="card-body row">
                            <div class="col-md-12">
                                ...
                                <div class="row" style="text-align: center;">
                                    ...
                                    <div class="form-group col-md-12">
                                        <a href="{{route('admin.listing-items.index',[32])}}" class="btn btn-sm btn-danger" target="_blank" > Etihad rail </a>
                                    </div>
                                </div>
                        ...
                        <div class="card-body row">
                            <div class="col-md-12">
                                <div class="row" style="text-align: center;">
                                    ...
                                    <div class="form-group col-md-12">
                                        Short Description
                                        <textarea name="section[short_description]" cols="30" rows="2" class="form-control">@if(!empty($data['join_the_club']['short_description'])){{$data['join_the_club']['short_description']}} @endif</textarea>
                                    </div>
                                    <div class="row">
                                    <div class="form-group col-md-6">
                                        Button Text
