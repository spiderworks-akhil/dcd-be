                ...
                <div class="card-body row">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="form-group col-md-12">
                                <a href="{{ route('admin.listing-items.index', [32]) }}" class="btn btn-sm btn-danger"
                                    target="_blank"> Etihad rail </a>
                            </div>
                        </div>
                ...
                <div class="card-body row">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="text-align: center;">
                            <div class="form-group col-md-12">
                                Short Description
                                <textarea name="section[short_description]" id="short_description" cols="30" rows="2"
                                    class="form-control">
