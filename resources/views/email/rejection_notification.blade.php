...
<head>
    ...
    <title>Content Rejection Notice</title>
    <!--[if mso]>
    <style type="text/css">
    ...
    <div style="max-width: 640px; margin: 0 auto; background-color: #ffffff;">
                ...
                <div style="position: relative; z-index: 1;">
                    ...
                    <div style="padding: 20px 21px 0 21px;">
                        <p style="margin: 0; padding: 0; font-family: 'Monument Grotesk', Arial, sans-serif; font-size: 20px; line-height: 20px; color: #9b9b9b; letter-spacing: 0.2px; font-weight: normal;">
                            Your submission has been reviewed and was not approved for publication.
                        </p>
                    </div>
        ...
        <div style="background-color: #ffffff; padding: 55px 74px 50px 74px;">
            ...
            <div style="padding-bottom: 5px;">
                 <h2 style="margin: 0; padding: 0; font-family: 'Monument Grotesk', Arial, sans-serif; font-size: 30px; line-height: 30px; color: #b40000; letter-spacing: 0.3px; font-weight: normal;">
                    Submission Rejected
                </h2>
            </div>
            ...
            <div style="padding-bottom: 30px;">
                <p style="margin: 0; padding: 0; font-family: 'Monument Grotesk', Arial, sans-serif; font-size: 20px; line-height: 30px; color: #191919; letter-spacing: 0.2px; font-weight: normal;">
                    Unfortunately, your content submission titled "<strong>{{ $title }}</strong>" did not meet the approval requirements. Please review the feedback below and make the necessary changes before resubmitting.
                </p>
            </div>

            <!-- Remarks (if available) -->
            @if (!empty($remarks))
                <div style="padding: 20px; background-color: #f9f9f9; border-left: 4px solid #b40000; margin-bottom: 30px;">
                    <p style="margin: 0; font-family: 'Monument Grotesk', Arial, sans-serif; font-size: 18px; line-height: 26px; color: #333;">
                        <strong>Remarks from Reviewer:</strong><br>
                        {{ $remarks }}
                    </p>
                </div>
            @endif
